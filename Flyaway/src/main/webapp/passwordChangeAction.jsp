...
<body>
	<%
			...
			String adminEmail = request.getParameter("adminuser");
			...
			if (newPassword.equals(confirmNewPasword)){
				...
				int rows = stmt.executeUpdate("UPDATE adminlogin SET adminpassword ='"+ newPassword+"' WHERE adminuser= '"+adminEmail+"' ");
